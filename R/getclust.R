...
#' 
#' 
#' @param hc an object of the type produced by \code{\link[COSA]{hierclust}} or \code{\link[stat]{hclust}}
...
#'
#' 
#' @seealso \code{\link[COSA]{hierclust}}, \code{\link[stats]{hclust}}, and \code{\link[cluster]{pam}}
#' 
#' 
#' @export
