...
#' @export                                                                               
hierclust <- function(D, main = "", leaflab = c("perpendicular", "textlike", "none")[3], cex.main = NULL, denplot = TRUE, sub = "", xlab = "COSA dissimilarity clustering", ylab = "", method = 'average', groupnr = NULL, colv = palette(), ...){
